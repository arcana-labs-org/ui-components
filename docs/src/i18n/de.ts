...
export const de: Messages = {
  ...
  components: {
    ...
    radio: {
      blurb: "Einzelner Radio-Button: natives <c>&lt;input type=\"radio\"&gt;</c> mit dem Design-System-Kreis und optionalem Label. Gruppiere mehrere über gemeinsames <c>name</c> und <c>v-model</c>."
    },
    radioCardGroup: {
