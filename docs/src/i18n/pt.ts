...
export const pt: Messages = {
  ...
  shell: {
    ...
    npmPackage: "@arcanalabs/ui-components no npm",
  ...
  gettingStarted: {
    ...
    deps: {
      title: "Dependências",
      p1: "Esta biblioteca <b>não tem dependências de runtime</b>: instalá-la não acrescenta nada ao seu bundle. Tudo abaixo é <b>peer</b> — fornecido pela sua aplicação e declarado aqui para você saber o que cada componente espera.",
      p2: "Toda peer é <b>opcional</b>: instale apenas o framework que você usa, mais os extras dos recursos que você renderiza. Nada quebra na instalação se você pular alguma — quem exige é o componente que precisa dela."
    },
    maska: {
      title: "Máscaras",
      p1: "A máscara de entrada está disponível nos <b>quatro frameworks</b> através do pacote <c>maska</c>, uma <b>peer dependency opcional</b> — instale-a quando renderizar um <c>ArcanaInputMask</c>. Só o Vue tem um passo a mais: registrar a diretiva <c>v-maska</c> globalmente uma vez, ao criar a aplicação.",
  ...
  dependencies: {
    ...
    note: "Nada aqui é baixado sem você pedir — peers opcionais só importam se você renderizar o componente que as usa."
  },
  ...
  components: {
    ...
    radio: {
      blurb: "Radio button único: <c>&lt;input type=\"radio\"&gt;</c> nativo com o círculo do design system e label opcional. Agrupe vários com o mesmo <c>name</c> e um <c>v-model</c> compartilhado."
    },
    radioCardGroup: {
