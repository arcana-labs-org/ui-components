...
<style lang="scss">
/* ─── Collapsible — header como button + chevron rotacionável ─── */
.shadcn-settings-list__group--collapsible > .shadcn-settings-list__group-head {
    width: 100%;
    border: none;
    background: #fafafa;
    cursor: pointer;
...
.shadcn-settings-list__group--collapsible > .shadcn-settings-list__group-head:hover {
    background: #f4f4f5;
}

.shadcn-settings-list__group--collapsible > .shadcn-settings-list__group-head:focus-visible {
    outline: 2px solid #18181b;
    outline-offset: -2px;
}

.shadcn-settings-list__group--collapsed > .shadcn-settings-list__group-head {
    border-bottom-color: transparent;
}

.shadcn-settings-list__group-head-right {
    display: flex;
    align-items: center;
    gap: 12px;
    flex-shrink: 0;
...
.shadcn-settings-list__group-chevron {
    width: 16px;
    height: 16px;
    color: #71717a;
...
.shadcn-settings-list__group--collapsed .shadcn-settings-list__group-chevron {
    transform: rotate(-90deg);
}

/* ─── Compact — densidade maior pro header + items ─── */
.shadcn-settings-list__group--compact > .shadcn-settings-list__group-head {
    padding: 10px 18px 9px;
}

.shadcn-settings-list__group--compact .shadcn-settings-list__group-icon {
    width: 26px;
    height: 26px;
    font-size: 12px;
}

.shadcn-settings-list__group--compact .shadcn-settings-list__group-title {
    font-size: 13px;
}

.shadcn-settings-list__group--compact .shadcn-settings-list__item {
    padding: 10px 18px;
}

.shadcn-settings-list__group--compact .shadcn-settings-list__item--nested {
    padding-left: 44px;
}

.shadcn-settings-list__group--compact .shadcn-settings-list__item--nested::before {
    left: 24px;
}

.shadcn-settings-list__group--compact .shadcn-settings-list__label {
    font-size: 13px;
}

.shadcn-settings-list__group--compact .shadcn-settings-list__caption {
    font-size: 12px;
}
</style>
