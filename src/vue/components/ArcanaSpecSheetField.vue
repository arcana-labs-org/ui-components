<template>
    <div class="arcana-spec-sheet__field" :style="Number(span) > 1 ? { gridColumn: 'span ' + span } : null">
        <div class="arcana-spec-sheet__label">{{ label }}</div>
        <div
            class="arcana-spec-sheet__value"
            :class="{ 'arcana-spec-sheet__value--empty': isEmpty }"
        >
...
/**
 * `<ArcanaSpecSheetField>` — campo individual no `<ArcanaSpecSheetSection>`.
 *
 ...
 *
 *     <ArcanaSpecSheetField label="Status">
