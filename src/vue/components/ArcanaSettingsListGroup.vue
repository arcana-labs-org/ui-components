<template>
    <section
        class="arcana-settings-list__group"
        :class="{
            'arcana-settings-list__group--compact': compact,
            'arcana-settings-list__group--collapsible': collapsible,
            'arcana-settings-list__group--collapsed': collapsible && isCollapsed,
        }"
    >
        <component
        ...
        >
            <div class="arcana-settings-list__group-head-left">
                ...
                <div>
                    <div v-if="sectionNum" class="arcana-settings-list__group-num">{{ sectionNum }}</div>
            ...
            <div class="arcana-settings-list__group-head-right">
                <div v-if="meta || $slots.meta" class="arcana-settings-list__group-meta">
...
/**
 * `<ArcanaSettingsListGroup>` — section interna do `<ArcanaSettingsList>` com header
