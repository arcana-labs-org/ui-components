<template>
    <div class="arcana-summary-tile" :class="rootClasses">
        <span v-if="icon" class="arcana-summary-tile__icon" aria-hidden="true">
            <i :class="icon"></i>
        </span>
        ...
        <div class="arcana-summary-tile__main">
            ...
            <span
                v-if="hasSub"
                class="arcana-summary-tile__sub"
            >
...
/**
 * `<ArcanaSummaryTile>` — tile compacto de KPI/resumo. Layout horizontal:
...
export default {
    ...
    computed: {
        rootClasses(): string {
            return `arcana-summary-tile--${this.tone}`
        },
