...
/**
 * `<ShadcnDatePicker>` — React port. Input de data shadcn com máscara `DD/MM/AAAA`.
 *
    ...
    if (isComposite) {
        return (
            <div className={rootClasses}>
                <div className="shadcn-date-picker__box">
                    <div
                        className="shadcn-date-picker__picker-anchor"
                        aria-hidden="true"
                    >
                        <input
                            ref={nativeRef}
                    ...
                    <input
                        className="shadcn-date-picker__text"
                        inputMode="numeric"
                        value={displayText}
                    ...
                    <button
                        type="button"
                        className="shadcn-date-picker__icon-btn"
                        disabled={disabled}
