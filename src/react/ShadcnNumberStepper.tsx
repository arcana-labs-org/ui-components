...
/**
 * `<ShadcnNumberStepper>` — React port. Reproduz `<div class="shadcn-number-stepper">`
...
export function ShadcnNumberStepper({
    value = 0,
    min = 0,
    ...
    return (
        <div className={rootClasses}>
            <button
                type="button"
                className="shadcn-number-stepper__btn shadcn-number-stepper__btn--decrement"
            ...
            <input
                type="number"
                className="shadcn-number-stepper__input"
                value={value ?? ""}
                min={min}
            ...
            <button
                type="button"
                className="shadcn-number-stepper__btn shadcn-number-stepper__btn--increment"
