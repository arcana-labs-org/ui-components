...
/**
 * `<ArcanaSelect>` — React port. Select custom arcana-style, totalmente em React/CSS
    ...
    return (
        <div className={rootClasses}>
            ...
            >
                ...
                {canClear ? (
                    <span
                        className="arcana-select__clear"
                        role="button"
                        tabIndex={-1}
                        aria-label="Limpar"
                        onClick={(e) => {
                ...
                <svg
                    className={["arcana-select__caret", isOpen ? "is-open" : ""]
                        .filter(Boolean)
                        .join(" ")}
                    width="12"
                    height="12"
            ...
            {isOpen
                ? createPortal(
                      <div
                          ref={panelRef}
                          className="arcana-select__panel"
                          style={panelStyles}
                          role="listbox"
                      ...
                      >
                          {searchable ? (
                              <div className="arcana-select__search">
                                  <svg
                                      className="arcana-select__search-icon"
                                      width="14"
                                      height="14"
                                      viewBox="0 0 24 24"
                                      fill="none"
                                  ...
                                  <input
                                      ...
                                      className="arcana-select__search-input"
                              ...
                              {filteredOptions.map((opt, idx) => (
                                  ...
                                  >
                                      ...
                                      <span className="arcana-select__item-body">
                                          ...
                                          {opt.description ? (
                                              <span className="arcana-select__item-desc">
                                                  {opt.description}
                                              </span>
                                          ) : null}
                                      </span>
