...
import { ArcanaOnboardingPanel } from "./ArcanaOnboardingPanel";

/**
 * `<ArcanaGridEmptyState>` — React port do SFC Vue. Mostra o `<ArcanaOnboardingPanel>`
...
export function ArcanaGridEmptyState({
    total,
    loading,
    filtered,
    icon,
