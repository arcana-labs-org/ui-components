...
import { ShadcnSelect, type SelectOption } from "./ShadcnSelect";

/**
 * `<ShadcnInputBoolean>` — React port. Renderiza um `<ShadcnSelect>` com opções
...
export function ShadcnInputBoolean({
    value,
    variation = "",
    disabled = false,
    clearable = true,
