...
/**
 * `<ShadcnInputMask>` — React port. Input mascarado shadcn (`class="shadcn-input"` +
 * `shadcn-input--${size}`/`--disabled`), idêntico ao SFC.
 *
...
export function ShadcnInputMask({
    value = "",
    mask,
    placeholder = "",
    disabled = false,
