 ...
 *
 * Attribute selector num `<div>` (`<div arcanaDatePicker>`): input de data shadcn
...
@Component({
  ...
  template: `
    @if (isComposite) {
      <div class="arcana-date-picker__box">
...
export class ArcanaDatePickerComponent implements OnChanges {
