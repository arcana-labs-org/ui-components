...
/**
 * `ArcanaNumberStepperComponent` — Angular port do SFC Vue `ArcanaNumberStepper`.
 *
 * Attribute selector num `<div>` (`<div arcanaNumberStepper>`): reproduz
 * `.arcana-number-stepper` (+ `is-disabled`), os `__btn--decrement`/`__btn--increment`
 ...
 */
@Component({
  selector: "div[arcanaNumberStepper]",
  standalone: true,
  ...
  template: `
    <button
      type="button"
      class="arcana-number-stepper__btn arcana-number-stepper__btn--decrement"
    ...
    <input
      type="number"
      class="arcana-number-stepper__input"
      [value]="value ?? ''"
      [min]="min"
      [attr.max]="maxAttr"
      [step]="step"
    ...
    <button
      type="button"
      class="arcana-number-stepper__btn arcana-number-stepper__btn--increment"
...
export class ArcanaNumberStepperComponent {
