...
/**
 * `ArcanaMultiSelectPopoverComponent` — Angular port do SFC Vue `MultiSelectPopover`.
 *
 ...
 *
 * Portal: mesma técnica do `ArcanaSelect` (EmbeddedView movida pro `document.body`, sem CDK).
 *
 * Vue → Angular:
...
export class ArcanaMultiSelectPopoverComponent implements OnChanges, OnDestroy {
