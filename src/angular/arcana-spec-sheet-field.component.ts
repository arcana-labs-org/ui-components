...
/**
 * `ArcanaSpecSheetFieldComponent` — Angular port do SFC Vue `ArcanaSpecSheetField`.
 *
 * Attribute selector num `<div>` (`<div arcanaSpecSheetField>`): campo individual da
 * `ArcanaSpecSheetSection`. Reproduz `.arcana-spec-sheet__field`, `__label`, `__value`
 ...
 */
@Component({
  selector: "div[arcanaSpecSheetField]",
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [NgTemplateOutlet],
  host: {
    "class": "arcana-spec-sheet__field",
    "[style.gridColumn]": "spanStyle"
  },
  template: `
    <div class="arcana-spec-sheet__label">{{ label }}</div>
    <div class="arcana-spec-sheet__value" [class.arcana-spec-sheet__value--empty]="isEmpty">
      @if (valueTemplate) {
...
export class ArcanaSpecSheetFieldComponent {
