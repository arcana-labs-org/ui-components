...
import { ArcanaOnboardingPanelComponent } from "./arcana-onboarding-panel.component";

/**
 * `ArcanaGridEmptyStateComponent` — Angular port do SFC Vue `SparkGridEmptyState`.
 *
 * Attribute selector num `<div>` (`<div arcanaGridEmptyState>`): mostra o
 * `<ArcanaOnboardingPanel>` só quando a grid terminou de carregar E está genuinamente vazia
 ...
 */
@Component({
  selector: "div[arcanaGridEmptyState]",
  standalone: true,
...
export class ArcanaGridEmptyStateComponent implements OnChanges, OnInit {
