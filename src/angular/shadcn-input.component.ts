...
/**
 * `ShadcnInputComponent` — Angular port do SFC Vue `ShadcnInput`.
 *
 * Attribute selector num `<input>` (`<input arcanaShadcnInput>`): o host É o próprio
 * `<input class="shadcn-input shadcn-input--${size}">`, idêntico ao Vue/React.
 *
 * Vue → Angular:
 ...
 */
@Component({
  selector: "input[arcanaShadcnInput]",
  standalone: true,
...
export class ShadcnInputComponent implements OnInit, OnDestroy {
