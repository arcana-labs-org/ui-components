<script lang="ts">
  ...
  import ShadcnSwitch from "./ShadcnSwitch.svelte";

  /**
   * `<ShadcnSwitchRow>` — Svelte 5 port. Toggle full-width "linha de configuração".
  ...
  const rootClasses = $derived(
    ["shadcn-switch-row", value ? "is-on" : "", disabled ? "is-disabled" : "", className]
      .filter(Boolean)
      .join(" ")
  );
...
>
  <div class="shadcn-switch-row__text">
    ...
    {#if hasDescription}
      <div class="shadcn-switch-row__sub">
