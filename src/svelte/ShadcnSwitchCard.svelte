<script lang="ts">
  ...
  /**
   * `<ShadcnSwitchCard>` — Svelte 5 port. Toggle full-width de alto impacto (card inverte
  ...
  const rootClasses = $derived(
    ["shadcn-switch-card", value ? "is-on" : "", disabled ? "is-disabled" : "", className]
      .filter(Boolean)
      .join(" ")
  );
...
>
  ...
  <div class="shadcn-switch-card__text">
    ...
    {#if hasStatus}
      <div class="shadcn-switch-card__status">
