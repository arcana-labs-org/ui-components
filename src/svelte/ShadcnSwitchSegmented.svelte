<script lang="ts">
  /**
   * `<ShadcnSwitchSegmented>` — Svelte 5 port. Reproduz `<div class="shadcn-switch-segmented">`
...
>
  ...
  <div class="shadcn-switch-segmented__option shadcn-switch-segmented__option--off">
    {#if radio}<span class="shadcn-switch-segmented__radio" aria-hidden="true"></span>{/if}
