...
<script lang="ts">
  /**
   * `<ShadcnSelect>` — Svelte 5 port. Select custom shadcn-style, todo em Svelte/CSS
   ...
   *
   * Decisões (parity com `react/ShadcnSelect.tsx`):
...
<div class={rootClasses}>
  ...
  >
    ...
    <svg
      class={["shadcn-select__caret", isOpen ? "is-open" : ""].filter(Boolean).join(" ")}
      width="12"
      height="12"
      viewBox="0 0 24 24"
      fill="none"
